				...
				<div id="blog-carousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						<div class="active carousel-item">
							<div class="overlaybg">
								<img src="/admin/assets/images/big/img7.jpg" class="card-img-radius img-fluid"
										 alt="blog">
							</div>
									...
									<td>
										<div class="popover-product">
                                                        <span class="popover-item">
                                                            <img src="/admin/assets/images/product/pro1.jpg" alt="product" />
                                                        </span>
											<span class="popover-item item-2">
                                                            <img src="/admin/assets/images/product/pro2.jpg" alt="product" />
                                                        </span>
											<span class="popover-item item-3">
                                                            <img src="/admin/assets/images/product/pro3.jpg" alt="product" />
                                                        </span>
