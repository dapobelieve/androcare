	...
	<nav class="navbar top-navbar navbar-expand-md navbar-dark">
		<div class="navbar-header">
			...
			<div class="navbar-brand">
				<a href="{{route('andro.home')}}" class="logo">
					<!-- Logo icon -->
					<b class="logo-icon">
						<!--You can put here icon as well // <i class="wi wi-sunset"></i> //-->
						<!-- Dark Logo icon -->
						<img style="height: 55px" src="{{config('androcare.website.logo')}}" alt="homepage" class="dark-logo" />
						<!-- Light Logo icon -->
						<img style="height: 55px" src="{{config('androcare.website.logo')}}" alt="homepage" class="light-logo" />
					</b>
					<!--End Logo icon -->
					<!-- Logo text -->
								...
								<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
									<div class="carousel-inner" role="listbox">
										<div class="carousel-item active">
											<div class="container p-0"> <img class="d-block img-fluid" src="/admin/assets/images/big/img1.jpg"
																											 alt="First slide"></div>
										</div>
										<div class="carousel-item">
											<div class="container p-0"><img class="d-block img-fluid" src="/admin/assets/images/big/img2.jpg"
																											alt="Second slide"></div>
										</div>
										<div class="carousel-item">
											<div class="container p-0"><img class="d-block img-fluid" src="/admin/assets/images/big/img3.jpg"
																											alt="Third slide"></div>
										</div>
									</div>
...
{{--                                    Mendy Simmons</span>--}}
{{--						<img src="/admin/assets/images/users/1.jpg" alt="user" class="rounded-circle" width="40">--}}
{{--					</a>--}}
{{--					<div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">--}}
{{--						<div class="d-flex no-block align-items-center p-3 bg-light mb-2">--}}
{{--							<div class="">--}}
{{--								<img src="/admin/assets/images/users/2.jpg" alt="user" class="rounded-circle"--}}
{{--										 width="60">--}}
{{--							</div>--}}
{{--							<div class="ml-2">--}}
...
{{--									<a href="javascript:void(0)" class="message-item">--}}
{{--                                                <span class="user-img">--}}
{{--                                                    <img src="/admin/assets/images/users/3.jpg" alt="user" class="rounded-circle">--}}
...
{{--									<a href="javascript:void(0)" class="message-item">--}}
{{--                                                <span class="user-img">--}}
{{--                                                    <img src="/admin/assets/images/users/4.jpg" alt="user" class="rounded-circle">--}}
