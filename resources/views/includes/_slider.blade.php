<section class="home-slider owl-carousel">
    <div class="slider-item" style="background-image:url(https://res.cloudinary.com/rohing/image/upload/v1597917782/androcare/assets/DSCN0251.jpg);" data-stellar-background-ratio="0.5">
{{--        <div class="overlay"></div>--}}
    ...
    <div class="slider-item" style="background-image:url(https://res.cloudinary.com/rohing/image/upload/v1597911157/androcare/assets/photo-1526256262350-7da7584cf5eb.jpg);">
        <div class="overlay"></div>
        <div class="container">
            <div class="row no-gutters slider-text align-items-center justify-content-start" data-scrollax-parent="true">
                <div class="col-md-12 text ftco-animate">
    ...
    <div class="slider-item" style="background-image:url(https://res.cloudinary.com/rohing/image/upload/v1597909782/androcare/assets/baby-child-kid-girl-161593.jpg);">
        <div class="overlay"></div>
        <div class="container">
            <div class="row no-gutters slider-text align-items-center justify-content-start" data-scrollax-parent="true">
                <div class="col-md-12 text ftco-animate">
